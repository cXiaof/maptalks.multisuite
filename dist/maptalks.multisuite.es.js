...
var MultiSuite = function (_maptalks$Class) {
    ...
    MultiSuite.prototype._checkIsSameType = function _checkIsSameType(geo) {
        var typeHit = geo.getType();
        var typeThis = this.geometry.getType();
    ...
    MultiSuite.prototype._getSymbolOrDefault = function _getSymbolOrDefault(geo, type) {
        ...
        if (symbol) {
            ...
            if (geo.getType().endsWith('Point')) symbol = Object.assign(markerStyleDefault, {
                markerFill: color
    ...
    MultiSuite.prototype._clickCombine = function _clickCombine() {
        if (this.hitGeo) {
            ...
            if (lodash_isequal(coordHit, coordThis)) return null;
            this._setChooseGeosExceptHit(coordHit);
            this._updateChooseGeos();
        }
    };
    ...
    MultiSuite.prototype._clickDecompose = function _clickDecompose(e) {
        var geosAll = this._chooseLayer.identify(e.coordinate);
        var geos = geosAll.reduce(function (target, geo) {
    ...
    MultiSuite.prototype._compositWithTargets = function _compositWithTargets() {
        ...
        this._deals = targets.map(function (geo) {
            return geo.copy();
        });
    ...
    MultiSuite.prototype._compositResultGeo = function _compositResultGeo(geos) {
        ...
        var combine = void 0;
        if (length > 1) switch (geos[0].getType()) {
            case 'Point':
    ...
    MultiSuite.prototype._fillAll = function _fillAll() {
        ...
        var result = new maptalks.Polygon([coords[0][0]], {
            symbol: symbol,
    ...
    MultiSuite.prototype._fillWithTargets = function _fillWithTargets() {
        ...
        var firstGeo = this.geometry.getCoordinates()[0];
        var coords = firstGeo.reduce(function (target, coord) {
...
typeof console !== 'undefined' && console.log('maptalks.multisuite v0.1.0, requires maptalks@>=0.31.0.');
